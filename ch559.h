...
__sfr   __at (0xE8)         IE_EX;      // extend interrupt enable
 ...
 __sbit __at (0xED)         IE_PWM1;    // enable PWM1 interrupt
 ...
 __sbit __at (0xE9)         IE_TMR3;    // enable timer3 interrupt
...
__sfr   __at (0x80)         P0;         // port 0 input & output
 ...
 __sbit __at (0x87)         UDCD;       // DCD input for UART1
 __sbit __at (0x86)         URI;        // RI input for UART1
 __sbit __at (0x85)         UDSR;       // DSR input for UART1
 __sbit __at (0x84)         UCTS;       // CTS input for UART1
 __sbit __at (0x83)         TXD_;       // alternate pin for TXD of UART0
 __sbit __at (0x82)         RXD_;       // alternate pin for RXD of UART0
 __sbit __at (0x81)         URTS;       // RTS output for UART1
 __sbit __at (0x80)         UDTR;       // DTR output for UART1
...
__sfr   __at (0x90)         P1;         // port 1 input & output, not 5VT
 ...
 __sbit __at (0x97)         AIN7;       // AIN7 for ADC, not 5VT
 __sbit __at (0x96)         AIN6;       // AIN6 for ADC, not 5VT
 __sbit __at (0x95)         AIN5;       // AIN5 for ADC, not 5VT
 __sbit __at (0x94)         AIN4;       // AIN4 for ADC, not 5VT
 __sbit __at (0x93)         AIN3;       // AIN3 for ADC, not 5VT
 __sbit __at (0x92)         AIN2;       // AIN2 for ADC, not 5VT
 __sbit __at (0x91)         AIN1;       // AIN1 for ADC, not 5VT
 __sbit __at (0x90)         AIN0;       // AIN0 for ADC, not 5VT
 __sbit __at (0x97)         SCK;        // serial clock for SPI0, not 5VT
 __sbit __at (0x96)         MISO;       // master serial data input or slave serial data output for SPI0, not 5VT
 __sbit __at (0x95)         MOSI;       // master serial data output or slave serial data input for SPI0, not 5VT
 __sbit __at (0x94)         SCS;        // slave chip-selection input for SPI0, not 5VT
 __sbit __at (0x92)         PWM3;       // PWM output for timer3, not 5VT
 __sbit __at (0x92)         CAP3;       // capture input for timer3, not 5VT
 __sbit __at (0x91)         T2EX;       // external trigger input for timer2 reload & capture, not 5VT
 __sbit __at (0x91)         CAP2;       // capture2 input for timer2, not 5VT
 __sbit __at (0x90)         T2;         // external count input, not 5VT
 __sbit __at (0x90)         CAP1;       // capture1 input for timer2, not 5VT
...
__sfr   __at (0xA0)         P2;         // port 2 input & output
 ...
 __sbit __at (0xA7)         TXD1;       // TXD output for UART1
 __sbit __at (0xA7)         DA7;        // address 7 output for direct low address mode
 __sbit __at (0xA6)         RXD1;       // RXD input for UART1
 __sbit __at (0xA5)         TNOW;       // tx now output for UART1, indicate transmitting
 __sbit __at (0xA5)         PWM2;       // second PWM output for PWM1
 __sbit __at (0xA5)         T2EX_;      // alternate pin for T2EX
 __sbit __at (0xA5)         CAP2_;      // alternate pin for CAP2
 __sbit __at (0xA4)         PWM1;       // PWM output for PWM1
 __sbit __at (0xA3)         SCK1;       // serial clock output for SPI1
 __sbit __at (0xA2)         MISO1;      // master serial data input for SPI1
 __sbit __at (0xA1)         MOSI1;      // master serial data output for SPI1
...
__sfr   __at (0xB0)         P3;         // port 3 input & output
 ...
 __sbit __at (0xB7)         RD;         // xdata or xBUS read strobe output
 __sbit __at (0xB6)         WR;         // xdata or xBUS write strobe output
 __sbit __at (0xB5)         DA6;        // address 6 output for direct low address mode
 __sbit __at (0xB5)         T1;         // external count input for timer1
 __sbit __at (0xB4)         LEDC;       // LEDC clock output for LED
 __sbit __at (0xB4)         XCS0;       // xBUS chip-selection 0# output, for address range 0x4000~0x7FFF
 __sbit __at (0xB4)         T0;         // external count input for timer0
 __sbit __at (0xB3)         LED1;       // LED1 data output
 __sbit __at (0xB3)         INT1;       // external interrupt 1 input
 __sbit __at (0xB2)         LED0;       // LED0 data output
...
__sfr   __at (0xC0)         P4_OUT;     // port 4 output
 ...
 __sbit __at (0xC7)         SCK_;       // alternate pin for SCK
 __sbit __at (0xC6)         SCS_;       // alternate pin for SCS
 __sbit __at (0xC5)         PWM2_;      // alternate pin for PWM2
 __sbit __at (0xC4)         LED3;       // LED3 data output
 __sbit __at (0xC4)         TNOW_;      // alternate pin for TNOW
 __sbit __at (0xC4)         TXD1_;      // alternate pin for TXD1
 __sbit __at (0xC3)         PWM1_;      // alternate pin for PWM1
 __sbit __at (0xC2)         PWM3_;      // alternate pin for PWM3
 __sbit __at (0xC2)         CAP3_;      // alternate pin for CAP3
 __sbit __at (0xC0)         LED2;       // LED2 data output
 __sbit __at (0xC0)         RXD1_;      // alternate pin for RXD1
...
__sfr16 __at (0xCDCC)       T2CAP1;     // ReadOnly: capture 1 value for timer2
__sfr   __at (0xCC)         T2CAP1L;    // ReadOnly: capture 1 value low byte for timer2
__sfr   __at (0xCD)         T2CAP1H;    // ReadOnly: capture 1 value high byte for timer2
...
__sfr16 __at (0xA5A4)       T3_COUNT;   // ReadOnly: current count value, little-endian
__sfr   __at (0xA4)         T3_COUNT_L; // ReadOnly: current count low byte
__sfr   __at (0xA5)         T3_COUNT_H; // ReadOnly: current count high byte
#define T3_CK_SE            T3_COUNT    // clock divisor setting, little-endian, lower 12 bits valid only
#define T3_CK_SE_L          T3_COUNT_L  // clock divisor setting low byte
#define T3_CK_SE_H          T3_COUNT_H  // clock divisor setting high byte, lower 4 bits valid only
__sfr16 __at (0xA7A6)       T3_END;     // end value for count, little-endian
...
__sfr16 __at (0xADAC)       T3_DMA;     // DMA address, must even address, little-endian, automatic increasing after DMA
...
__sfr16 __at (0xAFAE)       T3_FIFO;    // FIFO word, little-endian
...
__sfr   __at (0xF8)         SPI0_STAT;  // SPI 0 status
 ...
 __sbit __at (0xF9)         S0_R_FIFO1; // ReadOnly: rx FIFO count bit1 for SPI0
 __sbit __at (0xF8)         S0_R_FIFO0; // ReadOnly: rx FIFO count bit0 for SPI0
...
#define SPI0_S_PRE          SPI0_CK_SE  // preset value for SPI slave
...
#define SER1_RBR            SER1_FIFO   // ReadOnly: UART1 receiver buffer
#define SER1_THR            SER1_FIFO   // WriteOnly: UART1 transmitter holding
...
#define SER1_FCR            SER1_IIR  // WriteOnly: UART1 FIFO control
...
#define SER1_DLL            SER1_FIFO // UART1 divisor latch LSB byte if bLCR_DLAB=1
#define SER1_DLM            SER1_IER  // UART1 divisor latch MSB byte if bLCR_DLAB=1
#define SER1_DIV            SER1_ADDR // UART1 pre-divisor latch byte if bLCR_DLAB=1

/*  ADC Registers  */
__sfr16 __at (0xEDEC)       ADC_DMA;    // DMA address, must even address, little-endian, automatic increasing after DMA
...
__sfr16 __at (0xF5F4)       ADC_FIFO; // ReadOnly: FIFO word, little-endian
...
__sfr   __at (0xD8)         USB_INT_FG; // USB interrupt flag
 ...
 __sbit __at (0xDB)         UIF_HST_SOF;// host SOF timer interrupt flag for USB host, direct bit address clear or write 1 to clear
 ...
 __sbit __at (0xD8)         UIF_DETECT; // device detected event interrupt flag for USB host mode, direct bit address clear or write 1 to clear
 __sbit __at (0xD8)         UIF_BUS_RST;// bus reset event interrupt flag for USB device mode, direct bit address clear or write 1 to clear
...
#define UHUB0_CTRL          UDEV_CTRL // USB hub0 control
...
__sfr16 __at (0xE7E6)       USB_DMA;  // ReadOnly: current DMA address, little-endian
...
#define UH_SETUP            UEP1_CTRL // host aux setup
...
#define UH_RX_CTRL          UEP2_CTRL // host receiver endpoint control
...
#define UH_EP_PID           UEP2_T_LEN// host endpoint and token PID, lower 4 bits for endpoint number, upper 4 bits for token PID
#define MASK_UH_TOKEN       0xF0      // bit mask of token PID for USB host transfer
#define MASK_UH_ENDP        0x0F      // bit mask of endpoint number for USB host transfer
#define UH_TX_CTRL          UEP3_CTRL // host transmittal endpoint control
...
#define UH_TX_LEN           UEP3_T_LEN// host transmittal endpoint transmittal length
...
uint8_xv __at (0x2446)      UEP4_1_MOD; // endpoint 4/1 mode
uint8_pv __at (0x46)        pUEP4_1_MOD;
...
uint8_xv __at (0x2447)      UEP2_3_MOD; // endpoint 2/3 mode
uint8_pv __at (0x47)        pUEP2_3_MOD;
...
#define UH_EP_MOD           UEP2_3_MOD  // host endpoint mode
...
#define UH_RX_DMA           UEP2_DMA    // host rx endpoint buffer start address, big-endian
#define pUH_RX_DMA          pUEP2_DMA
#define UH_RX_DMA_H         UEP2_DMA_H  // host rx endpoint buffer start address high byte
#define pUH_RX_DMA_H        pUEP2_DMA_H
#define UH_RX_DMA_L         UEP2_DMA_L  // host rx endpoint buffer start address low byte
#define pUH_RX_DMA_L        pUEP2_DMA_L
#define UH_TX_DMA           UEP3_DMA    // host tx endpoint buffer start address, big-endian
#define pUH_TX_DMA          pUEP3_DMA
#define UH_TX_DMA_H         UEP3_DMA_H  // host tx endpoint buffer start address high byte
#define pUH_TX_DMA_H        pUEP3_DMA_H
#define UH_TX_DMA_L         UEP3_DMA_L  // host tx endpoint buffer start address low byte
#define pUH_TX_DMA_L        pUEP3_DMA_L

/*  LED Registers on xDATA, xSFR  */
#define REG_LED_BASE        0x2880      // LED registers base address
uint8_xv __at (0x2880)      LED_STAT;   // LED status
uint8_pv __at (0x80)        pLED_STAT;
...
uint8_xv __at (0x2881)      LED_CTRL;   // LED control
uint8_pv __at (0x81)        pLED_CTRL;
...
uint8_xv __at (0x2882)      LED_DATA; // WriteOnly: data port
uint8_pv __at (0x82)        pLED_DATA;
#define LED_FIFO_CN         LED_DATA  // ReadOnly: FIFO count status
uint8_xv __at (0x2883)      LED_CK_SE;// clock divisor setting
uint8_pv __at (0x83)        pLED_CK_SE;
uint8_xv __at (0x2884)      LED_DMA_AH; // DMA address high byte, automatic increasing after DMA
...
uint8_xv __at (0x2888)      LED_DMA_XH; // aux buffer DMA address high byte, automatic increasing after DMA
